    ...
    <div class="container ">
        <div class="row login-elements-container">
            ...
            <aside class=" col-md-6 col-lg-4 d-none d-md-block " >
              <img class="card my-cover" src="../assets/images/cover.jpg" alt="Cover massage image 2">
              <img class="card my-cover bottom-image" src="../assets/images/cover2.jpg" alt="Cover massage image 3">
            </aside>
